...
class PlatformBuilder {
    ...
    createHttpServers() {
        this.#servers = [(0, createHttpServer_1.createHttpServer)(this.#injector, this.callback()), (0, createHttpsServer_1.createHttpsServer)(this.#injector, this.callback())].filter(Boolean);
    }
    async listenServers() {
