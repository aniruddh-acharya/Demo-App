...
let PlatformCache = class PlatformCache {
    ...
    async get(key, options = {}) {
        return (0, json_mapper_1.deserialize)(this.cache?.get(key), options);
    }
    ...
    async createCacheManager(settings) {
        ...
        const { multiCaching, caching } = await Promise.resolve().then(() => tslib_1.__importStar(require("cache-manager")));
