...
function isExample(key, value, options) {
    return key === "examples" && (0, core_1.isObject)(value) && SpecTypes_1.SpecTypes.OPENAPI === options.specType;
}
function schemaMapper(schema, options) {
    ...
    if (schema.isClass) {
        obj = (0, JsonSchemaMapperContainer_1.execMapper)("inheritedClass", obj, { ...options, root: false, schemas, target: schema.getComputedType() });
    }
    obj = (0, JsonSchemaMapperContainer_1.execMapper)("generics", obj, { ...options, root: false, schemas });
    ...
    obj = (0, getRequiredProperties_1.getRequiredProperties)(obj, schema, { ...options, useAlias });
